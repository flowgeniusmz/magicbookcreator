...
user_instruction = "Provide the title and summary based on the story data provided. Then using the image_url provided describe the main person in this image. Provide the json output."
