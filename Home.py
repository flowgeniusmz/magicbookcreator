...
with tab_BS:
    ...
    with container2: 
        ...
        with cc2[0]:
            exp21 = st.expander("Page 2 Narrative", expanded = True)
        with cc2[2]: 
            exp22 = st.expander("Page 2 Illustration", expanded = True)
    ...
    with container4: 
        ...
        with cc4[0]:
            exp41 = st.expander("Page 4 Narrative", expanded = True)
        with cc4[2]: 
            exp42 = st.expander("Page 4 Illustration", expanded = True)
    ...
    with container6: 
        ...
        with cc6[0]:
            exp61 = st.expander("Page 6 Narrative", expanded = True)
        with cc6[2]: 
            exp62 = st.expander("Page 6 Illustration", expanded = True)
    ...
    with container8: 
        ...
        with cc8[0]:
            exp81 = st.expander("Page 8 Narrative", expanded = True)
        with cc8[2]: 
            exp82 = st.expander("Page 8 Illustration", expanded = True)
            
    container9 = st.container(border=True)
    with container9: 
        cc9 = st.columns([3,1,3])
        with cc9[0]:
            exp92 = st.expander("Page 9 Narrative", expanded = True)
        with cc9[2]: 
            exp91 = st.expander("Page 9 Illustration", expanded = True)
            
    container10 = st.container(border=True)
    with container10: 
        cc10 = st.columns([3,1,3])
        with cc10[0]:
            exp101 = st.expander("Page 10 Narrative", expanded = True)
        with cc10[2]: 
            exp102 = st.expander("Page 10 Illustration", expanded = True)
